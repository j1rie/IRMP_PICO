...
#define SIRCS_START_BIT_PULSE_LEN_MIN           (uint_fast8_t)(F_INTERRUPTS * SIRCS_START_BIT_PULSE_TIME * 0.88 + 0.5) // +?
#define SIRCS_START_BIT_PULSE_LEN_MAX           (uint_fast8_t)(F_INTERRUPTS * SIRCS_START_BIT_PULSE_TIME * 1.13 + 0.5)
...
#  define SIRCS_START_BIT_PAUSE_LEN_MAX         (uint_fast8_t)(F_INTERRUPTS * SIRCS_START_BIT_PAUSE_TIME * MAX_TOLERANCE_30 + 0.5) // war 15
#endif
#define SIRCS_1_PULSE_LEN_MIN                   (uint_fast8_t)(F_INTERRUPTS * SIRCS_1_PULSE_TIME * MIN_TOLERANCE_15 + 0.5)
#define SIRCS_1_PULSE_LEN_MAX                   (uint_fast8_t)(F_INTERRUPTS * SIRCS_1_PULSE_TIME * 1.14 + 0.5)
#define SIRCS_0_PULSE_LEN_MIN                   (uint_fast8_t)(F_INTERRUPTS * SIRCS_0_PULSE_TIME * MIN_TOLERANCE_30 + 0.5)
#define SIRCS_0_PULSE_LEN_MAX                   (uint_fast8_t)(F_INTERRUPTS * SIRCS_0_PULSE_TIME * MAX_TOLERANCE_30 + 0.5) // war 15
#define SIRCS_PAUSE_LEN_MIN                     (uint_fast8_t)(F_INTERRUPTS * SIRCS_PAUSE_TIME * MIN_TOLERANCE_30 + 0.5)
#define SIRCS_PAUSE_LEN_MAX                     (uint_fast8_t)(F_INTERRUPTS * SIRCS_PAUSE_TIME * MAX_TOLERANCE_30 + 0.5) // war 15
...
#define RC6_START_BIT_PULSE_LEN_MAX             (uint_fast8_t)(F_INTERRUPTS * RC6_START_BIT_PULSE_TIME * MAX_TOLERANCE_15 + 0.5)
#define RC6_START_BIT_PAUSE_LEN_MIN             (uint_fast8_t)(F_INTERRUPTS * RC6_START_BIT_PAUSE_TIME * MIN_TOLERANCE_15 + 0.5)
#define RC6_START_BIT_PAUSE_LEN_MAX             (uint_fast8_t)(F_INTERRUPTS * RC6_START_BIT_PAUSE_TIME * MAX_TOLERANCE_15 + 0.5)
#define RC6_TOGGLE_BIT_LEN_MIN                  (uint_fast8_t)(F_INTERRUPTS * RC6_TOGGLE_BIT_TIME * MIN_TOLERANCE_15 + 0.5)
#define RC6_TOGGLE_BIT_LEN_MAX                  (uint_fast8_t)(F_INTERRUPTS * RC6_TOGGLE_BIT_TIME * MAX_TOLERANCE_15 + 0.5)
#define RC6_BIT_PULSE_LEN_MIN                   (uint_fast8_t)(F_INTERRUPTS * RC6_BIT_TIME * MIN_TOLERANCE_25 + 0.5)
#define RC6_BIT_PULSE_LEN_MAX                   (uint_fast8_t)(F_INTERRUPTS * RC6_BIT_TIME * MAX_TOLERANCE_70 + 0.5)       // pulses: 300 - 800
#define RC6_BIT_PAUSE_LEN_MIN                   (uint_fast8_t)(F_INTERRUPTS * RC6_BIT_TIME * MIN_TOLERANCE_25 + 0.5)
#define RC6_BIT_PAUSE_LEN_MAX                   (uint_fast8_t)(F_INTERRUPTS * RC6_BIT_TIME * MAX_TOLERANCE_30 + 0.5)       // pauses: 300 - 600
...
#define SIEMENS_OR_RUWIDO_START_BIT_PULSE_LEN_MIN       (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_START_BIT_PULSE_TIME * MIN_TOLERANCE_30 + 0.5)
#define SIEMENS_OR_RUWIDO_START_BIT_PULSE_LEN_MAX       (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_START_BIT_PULSE_TIME * MAX_TOLERANCE_30 + 0.5)
#define SIEMENS_OR_RUWIDO_START_BIT_PAUSE_LEN_MIN       (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_START_BIT_PAUSE_TIME * MIN_TOLERANCE_20 + 0.5)
#define SIEMENS_OR_RUWIDO_START_BIT_PAUSE_LEN_MAX       (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_START_BIT_PAUSE_TIME * MAX_TOLERANCE_20 + 0.5)
#define SIEMENS_OR_RUWIDO_BIT_PULSE_LEN_MIN             (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_BIT_PULSE_TIME * MIN_TOLERANCE_20 + 0.5)
#define SIEMENS_OR_RUWIDO_BIT_PULSE_LEN_MAX             (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_BIT_PULSE_TIME * MAX_TOLERANCE_30 + 0.5)
#define SIEMENS_OR_RUWIDO_BIT_PAUSE_LEN_MIN             (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_BIT_PAUSE_TIME * MIN_TOLERANCE_10 + 0.5)
#define SIEMENS_OR_RUWIDO_BIT_PAUSE_LEN_MAX             (uint_fast8_t)(F_INTERRUPTS * SIEMENS_OR_RUWIDO_BIT_PAUSE_TIME * MAX_TOLERANCE_20 + 0.5)
...
#define LEGO_START_BIT_PULSE_LEN_MIN            (uint_fast8_t)(F_INTERRUPTS * LEGO_START_BIT_PULSE_TIME * MIN_TOLERANCE_70 + 0.5)
#define LEGO_START_BIT_PULSE_LEN_MAX            (uint_fast8_t)(F_INTERRUPTS * LEGO_START_BIT_PULSE_TIME * MAX_TOLERANCE_70 + 0.5)
#define LEGO_START_BIT_PAUSE_LEN_MIN            (uint_fast8_t)(F_INTERRUPTS * LEGO_START_BIT_PAUSE_TIME * 0.55 + 0.5) //
#define LEGO_START_BIT_PAUSE_LEN_MAX            (uint_fast8_t)(F_INTERRUPTS * LEGO_START_BIT_PAUSE_TIME * 1.45 + 0.5) //
#define LEGO_PULSE_LEN_MIN                      (uint_fast8_t)(F_INTERRUPTS * LEGO_PULSE_TIME * MIN_TOLERANCE_70 + 0.5)
#define LEGO_PULSE_LEN_MAX                      (uint_fast8_t)(F_INTERRUPTS * LEGO_PULSE_TIME * MAX_TOLERANCE_70 + 0.5)
#define LEGO_1_PAUSE_LEN_MIN                    (uint_fast8_t)(F_INTERRUPTS * LEGO_1_PAUSE_TIME * 0.65 + 0.5) //
#define LEGO_1_PAUSE_LEN_MAX                    (uint_fast8_t)(F_INTERRUPTS * LEGO_1_PAUSE_TIME * MAX_TOLERANCE_50 + 0.5)
#define LEGO_0_PAUSE_LEN_MIN                    (uint_fast8_t)(F_INTERRUPTS * LEGO_0_PAUSE_TIME * MIN_TOLERANCE_60 + 0.5)
#define LEGO_0_PAUSE_LEN_MAX                    (uint_fast8_t)(F_INTERRUPTS * LEGO_0_PAUSE_TIME * MAX_TOLERANCE_30 + 0.5) // etwas weniger?
...
#define A1TVBOX_START_BIT_PULSE_LEN_MIN         (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_START_BIT_PULSE_TIME * MIN_TOLERANCE_30 + 0.5)
#define A1TVBOX_START_BIT_PULSE_LEN_MAX         (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_START_BIT_PULSE_TIME * MAX_TOLERANCE_40 + 0.5)
#define A1TVBOX_START_BIT_PAUSE_LEN_MIN         (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_START_BIT_PAUSE_TIME * MIN_TOLERANCE_40 + 0.5) // 30?
#define A1TVBOX_START_BIT_PAUSE_LEN_MAX         (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_START_BIT_PAUSE_TIME * MAX_TOLERANCE_15 + 0.5)
#define A1TVBOX_BIT_PULSE_LEN_MIN               (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_BIT_PULSE_TIME * MIN_TOLERANCE_40 + 0.5)
#define A1TVBOX_BIT_PULSE_LEN_MAX               (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_BIT_PULSE_TIME * MAX_TOLERANCE_50 + 0.5)
#define A1TVBOX_BIT_PAUSE_LEN_MIN               (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_BIT_PAUSE_TIME * MIN_TOLERANCE_40 + 0.5)
#define A1TVBOX_BIT_PAUSE_LEN_MAX               (uint_fast8_t)(F_INTERRUPTS * A1TVBOX_BIT_PAUSE_TIME * MAX_TOLERANCE_50 + 0.5)
